...
var _NameList = __webpack_require__(28);
...
var NameList = function (_React$Component) {
	...
	_createClass(NameList, [{
		...
		key: "render",
		value: function render() {
			var nameArray = ["Chrisas", "Johans", "Billybobs", "Joeyjoe", "Tomass"];
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(_Welcome2.default, { firstName: "Chris", element: element }),
				_react2.default.createElement(
					"ul",
					null,
					this.nameMapper(nameArray)
				),
				_react2.default.createElement(_Welcome2.default, { thisfirstName: "Jane", lastName: "Doeese" })
			);
		}
	}]);
